drop materialized view prod."Cumulative_BadRates_Mv_Test" cascade;
create materialized view prod."Cumulative_BadRates_Mv_Test" as
...
VintageIndicators as (
	SELECT 
	  ...
	  where   ad."AgeInMonths"  >= rm."MonthsOnBook"::numeric  --Added the one month to move the indiactors into the correct bucket.
),
...
select * from vintageidicator_summary;
