--This query returns all Bank detail records related to applications for the current month 
...
select 	bd.* 
from 		backoffice.sqlmig."Application" a , backoffice.sqlmig."BankDetail" bd
      , parameters p
where   a."CreateDate" between p."SevenDaysPriorStart" and p."EndDate"
and     a."BankDetailId"  = bd."BankDetailId";